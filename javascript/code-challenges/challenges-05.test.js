...
const addValues = (arr) => arr.reduce((prevTotal, num) => prevTotal + num, 0);
...
const addPurchases = (arr) => arr.reduce((prevPrice, merchandise) => prevPrice + merchandise.purchasePrice, 0);
...
const countNumberOfElements = (arr) => arr.reduce((count, i) => i? count + 1 : count, 0);
/* ------------------------------------------------------------------------------------------------
CHALLENGE 5
...
const returnNames = (arr) => arr.reduce((names, character) => {
...
const reversedString = (str) => {
  let result = [...str];
  return result.reduce((reverse, char) => {
