...
const updateAnimal = (arr, callback) => {
  let result = [];
  arr.forEach(value => result.push(callback(value)));
  return result;
};
...
const alphabetizeBetter = (arr) => arr.sort((a, b) => a.toLowerCase() > b.toLowerCase()? 1
...
let sortValues = {Monday: 1, Tuesday: 2, Wednesday: 3, Thursday: 4, Friday: 5};

const sortMeetingsByDay = (arr) => arr.sort((a, b) => sortValues[a.dayOfWeek] - sortValues[b.dayOfWeek]);
...
const sortSchedule = (arr) => arr.sort((a, b) =>
  sortValues[a.dayOfWeek] > sortValues[b.dayOfWeek]? 1
    : sortValues[a.dayOfWeek] < sortValues[b.dayOfWeek]? -1
      : a.start > b.start? 1
        : b.start < b.start? -1
