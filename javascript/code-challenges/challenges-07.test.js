...
const listFoods = (recipe) => {
  ...
  recipe.ingredients.forEach((ingredient) => {
    let firstSlice = ingredient.slice(ingredient.indexOf(' ') + 1, ingredient.length);
    result.push(firstSlice.slice(firstSlice.indexOf(' ') + 1, firstSlice.length));
  });
  return result;
};
