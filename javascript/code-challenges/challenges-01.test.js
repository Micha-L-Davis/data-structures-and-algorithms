...
const addOne = (arr) => {
  let results = [];
  arr.forEach(num => results.push(num + 1));
  return results;
};
...
const addExclamation = (arr) => {
  let results = [];
  arr.forEach(str => results.push(str + '!'));
  return results;
};
...
const allUpperCase = (arr) => {
  let results = [];
  arr.forEach(str => results.push(str.toUpperCase()));
  return results;
};
...
const createList = (availableItems) => {
  let groceryList = [];
  availableItems.forEach(item => item.available? groceryList.push(item.name) : console.log(`${item.name} unavailable`));
  return groceryList;
};
...
const fizzbuzz = (arr) => {
  let result = [];
  arr.forEach(num => (num % 15 === 0)? result.push('Fizz Buzz')
    : (num % 3 === 0)? result.push('Fizz')
      : (num % 5 === 0)? result.push('Buzz')
        : result.push(num));
  return result;
};
