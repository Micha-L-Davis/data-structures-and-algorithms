...
const longestString = (arr) => arr.reduce((longestIndex, string, index) =>
  string.length > longestIndex.length? {length: string.length, index: index}
    : longestIndex , {length: 0, index: -1})
  .index;
